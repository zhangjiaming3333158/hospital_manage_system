    ...
    children: [
      {
        ...
        meta: { title: '商标管理', icon: 'el-icon-s-marketing' },
      },
      {
        path: 'attr',
        name: 'Attr',
        component: () => import('@/views/product/Attr/index'),
        meta: { title: '属性管理', icon: 'el-icon-s-order' },
      },
      {
        path: 'sku',
        name: 'Sku',
        component: () => import('@/views/product/Sku/index'),
        meta: { title: 'SKU管理', icon: 'el-icon-s-goods' },
      },
      {
        path: 'spu',
        name: 'Spu',
        component: () => import('@/views/product/Spu/index'),
        meta: { title: 'SPU管理', icon: 'el-icon-s-goods' },
      },
    ],
  },
]
